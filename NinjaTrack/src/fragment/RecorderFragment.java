...
public class RecorderFragment extends Fragment {
	...
	private static void ManipulateUI(String title, boolean isPlaying){
		int position = 0;
		for(Song song : RecorderFragment.songList) {
			if(title.equals(song.getTitle())) {
				View view = RecorderFragment.adapter.getView(RecorderFragment.adapter.getPosition(song), null, RecorderFragment.lv_song);
